...
public class ManufacturePane extends BorderPane {
	...
	public ManufacturePane()
	{
		...
		ta.setText("Product id:" +'\t'+ "Product checked:"+'\t'+"Product condition:"+'\t');
		///for login
setStyle("-fx-background-color: grey");
	...
	//creates a new Transaction
			...
			{
				 trans = new Transaction<String>("Manufacturer","Shipment",ta.getText());
				
				
				//setting the data in the transaction
				trans.setData(ta.getText()); 
				trans.setSender("Manufacturer");
				trans.setReceiver("Shipment");
				//ll.add(trans);
				list.AddFirst(trans);
			...
			{
				pw.println("SEND"+'\s'+"Manufacturer"+"\s"+ list.toString());//+trans.toString());//+txtBlock.getText());
				pw.flush();
				AddBlock();
				/*try {
		...
		public Block<String> AddBlock()
		{
			...
			block = new Block<String>("Manufacturer",list);
