...
public class SupplyAdmin extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		//set up for login scene
				...
				Scene Adminscene= new Scene(admin,1000,800);
		            
				
				//Changing scenes for different usersGates
				if(txtUsername.getText().equals("Admin") && txtpassword.getText().equals("321"))
				{
					btnLogin.setOnAction(e -> primaryStage.setScene(Adminscene) ); //System.out.print("Go//txtStatus.setText(strUsername + strPassword) );
					
					//primaryStage.setScene(scene1)
					
				}
					
				btnLogin.setOnAction(e -> primaryStage.setScene(Adminscene) );
				primaryStage.setTitle("SITHEBE SUPPLY CHAIN Admin");
