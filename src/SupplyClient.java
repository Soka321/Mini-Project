 ...
 * Graphic user interface set up and funtionality executed here
 */
public class SupplyClient extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Scene Clientscene= new Scene(CPane,1000,800);
            
		
		//Changing scenes for different usersGates
		if(txtUsername.getText().equals("Client") && txtpassword.getText().equals("321"))
		{
		...
		primaryStage.setTitle("SITHEBE SUPPLY CHAIN : Client");
